...
function injectBotUI() {
    ...
    const headerContent = (typeof APP_CONFIG !== 'undefined' && APP_CONFIG.team === 'fs')
        ? `<div style="margin-bottom: 5px;">
             <img src="https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExeXBrZ2lxeG9wODVrdXAwbW9sM2pjcWdiajZwbGtiaW5mdnFtaWYxdyZlcD12MV9naWZzX3RyZW5kaW5nJmN0PWc/1ojn1S7BTXUry8elNi/giphy.gif" alt="FS Logo" style="max-height: 45px; border-radius: 5px; display: block;">
           </div>`
